---
title: "Towards Real-Time Simulation and Registration of human lungs"
subtitle: "CSMA 2026"
date: 04/19/2026
author: 
...
## Why a lung digital twin ? 

:::: {.columns}

::: {.column width="50%"}

![Inspiration & expiration of diseased lungs](Figures/Movies/lung-im.mp4){ height="250" loop="true" autoplay=true}

:::

::: {.column width="50%"}

![Digital twin from images](Figures/Movies/Lungs_digital_twin.mp4){ height="250" loop="true" autoplay=true}
...
* See **Martin**'s talk on Wednesday at the plenary session
...
* [Mechanical model of the lung [@patteQuasistaticPoromechanicalModel2022;@peyrautQuantificationDincertitudesPour2024a]]{.positive}
  * **Haotian Xiao** : Modélisation à double porosité d’une microstructure à trois
phases pour la perfusion pulmonaire
...
## Simplified (linear) lung digital twin

:::: {.columns}

::: {.column width="50%"}

![Multi-level training convergence](Schemes/lung_pressure_zoomed.svg){width=60%}

* $\Pi = W_{\text{int}} + \int_{\partial \Omega} k_b \Vert \vect{u}\cdot \vect{n} \Vert^2 \mathrm{d}S - \int_{\partial \Omega} p \vect{u} \cdot \vect{n}$
  * $p = p_0 + H\left(z-z_0 \right) + H\left(x-x_0 \right)$

:::: {style='margin-top: 1em;'}
::::

* **Difficulty** : Knowing the physiological boundary conditions
  * **Felipe Álvarez-Barriento** : Data-driven reduced modeling of pleural pressure - 10:15 am on Friday 
...
![](Figures/Movies/Lung_gravity_ter.mov){ width=90% loop="true" autoplay=true fig-align="center"}
...
* Robust and straightforward general implementation of a **autodiff-PGD**
  * Interpretable
...
![](Figures/Movies/Lung_gravity_ter.mov){.absolute height=130 loop="true" autoplay=true}
